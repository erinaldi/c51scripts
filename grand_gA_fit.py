...
if __name__=="__main__":
    ...
    priors['fpi'] = decay.decay_constant(decay_params,pifit['meson_fit'].p['Z0_p'],pifit['meson_fit'].p['E0'],mresl['mres_fit'].p['mres'])/np.sqrt(2)
    ...
    data = gv.BufferDict()
    data['gA'] = gAfit['gA_fit'].p['gA00']/gAfit['gA_fit'].p['gV00']
    print "fit.p output (CHECK AGAINST fit):", gAfit['gA_fit'].p['gA00']
    # write output
